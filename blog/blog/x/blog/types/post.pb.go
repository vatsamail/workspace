...
func init() {
	proto.RegisterType((*Post)(nil), "alice.blog.blog.Post")
}
...
var fileDescriptor_1da4a141e1c534d3 = []byte{
	...
	0xd7, 0x2f, 0xc8, 0x2f, 0x2e, 0xd1, 0x2b, 0x28, 0xca, 0x2f, 0xc9, 0x17, 0xe2, 0x4f, 0xcc, 0xc9,
	0x4c, 0x4e, 0xd5, 0x03, 0x09, 0x83, 0x09, 0xa5, 0x3c, 0x2e, 0x96, 0x80, 0xfc, 0xe2, 0x12, 0x21,
	...
	0xc2, 0x11, 0x12, 0xe2, 0x62, 0x49, 0xca, 0x4f, 0xa9, 0x94, 0x60, 0x01, 0x0b, 0x82, 0xd9, 0x20,
	0xb1, 0x92, 0xc4, 0xf4, 0x62, 0x09, 0x56, 0x88, 0x18, 0x88, 0xed, 0x64, 0x73, 0xe2, 0x91, 0x1c,
	0xe3, 0x85, 0x47, 0x72, 0x8c, 0x0f, 0x1e, 0xc9, 0x31, 0x4e, 0x78, 0x2c, 0xc7, 0x70, 0xe1, 0xb1,
	0x1c, 0xc3, 0x8d, 0xc7, 0x72, 0x0c, 0x51, 0x4a, 0xe9, 0x99, 0x25, 0x19, 0xa5, 0x49, 0x7a, 0xc9,
	0xf9, 0xb9, 0xfa, 0x60, 0x57, 0xea, 0x83, 0x1d, 0x5f, 0x01, 0xa1, 0x4a, 0x2a, 0x0b, 0x52, 0x8b,
	0x93, 0xd8, 0xc0, 0xbe, 0x30, 0x06, 0x04, 0x00, 0x00, 0xff, 0xff, 0x1b, 0x48, 0x81, 0x58, 0xd8,
	0x00, 0x00, 0x00,
}
...
func (m *Post) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Tags) > 0 {
		i -= len(m.Tags)
		copy(dAtA[i:], m.Tags)
		i = encodeVarintPost(dAtA, i, uint64(len(m.Tags)))
		i--
		dAtA[i] = 0x2a
	}
	if len(m.Body) > 0 {
